      ...
      <section className="container mx-auto max-w-5xl flex flex-col px-5 py-5 items-center lg:flex-row lg:items-start lg:gap-x-3">
        <article className="flex-1">
          ...
          <Link
            ...
            className="text-primary font-roboto text-sm inline-block mt-4"
          >
            Robotics
          </Link>
          ...
          <div className="mt-4 text-dark-soft mb-10">
            <p className="leading-7">
              Voluptate aute anim ut sunt enim cillum veniam. Id nostrud irure
              eiusmod ullamco sint ullamco velit Lorem adipisicing magna nulla
              sint. Laboris nulla elit voluptate minim sint Lorem. Magna aliquip
              veniam anim sunt exercitation eu labore dolor commodo deserunt
              aute eu id. Culpa deserunt magna do sit cillum. Sit dolore elit
              tempor ea sint ut sint veniam. Dolor eiusmod in consectetur qui
              veniam dolore id anim occaecat non excepteur. Nulla sint sit ut
              dolore cillum ut cupidatat quis in minim culpa consectetur. Duis
              fugiat officia id esse culpa ex cillum consequat deserunt.
            </p>
          </div>
