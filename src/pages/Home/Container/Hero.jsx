    ...
    <section className='container mx-auto flex flex-col px-5 py-5 lg:flex-row'>
      <div className='mt-10 lg:w-1/2'>
        ...
        <div className='flex flex-col gap-y-2 mt-10 relative items-center lg:items-start'>
          ...
          <Button className='w-1/2 bg-primary text-white font-semibold rounded-lg px-4 py-3 md:absolute lg:left-[228px] lg:top-1/2 lg:-translate-y-1/2 lg:w-fit lg:py-2 md:-bottom-14 lg:-bottom-4'>Search !!</Button>
        </div>
