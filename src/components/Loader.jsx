...
const Loader = () => {
  return (
    <div className='text-gray-400 italic font-extrabold text-center text-6xl fixed top-0 w-[100%] h-[100%] flex bg-black/50 items-center justify-center'>
          <svg xmlns="http://www.w3.org/2000/svg" width="150px" height="150px" viewBox="0 0 100 100">
    <path d="M 50,50 L 33,60.5 a 20 20 -210 1 1 34,0 z" fill="#c0c0c0">
